...
### 2.7 Лабораторийн эрхийн хяналт (allowed_labs)

- Хэрэглэгч бүрт `allowed_labs` талбараар лаб хандах эрх хянагдана
- Зөвшөөрөгдөөгүй лабын endpoint-д хандвал 403 Forbidden
