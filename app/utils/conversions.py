...
def calculate_all_conversions(
    raw_canonical_results: Dict[str, Any],
    ...
    def get_float_from_raw(key: str) -> Optional[float]:
    ...
    def get_float_from_any(key: str) -> Optional[float]:
