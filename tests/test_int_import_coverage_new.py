...
class TestImportHelperFunctions:
    ...
    def test_norm_with_string(self, app):
        ...
        from app.routes.import_routes import _norm
    ...
    def test_parse_date_valid_formats(self, app):
        ...
        from app.routes.import_routes import _parse_date
    ...
    def test_map_header(self, app):
        ...
        from app.routes.import_routes import _map_header
    ...
    def test_base_code(self, app):
        ...
        from app.routes.import_routes import _base_code
    ...
    def test_get_or_create_sample_new(self, app):
        ...
        from app.routes.import_routes import _get_or_create_sample
    ...
    def test_upsert_result_new(self, app):
        ...
        from app.routes.import_routes import _upsert_result
        from app.models import Sample
        from app import db
    ...
    def test_upsert_result_update(self, app):
        ...
        with app.app_context():
            ...
            is_new1, _ = _upsert_result(
                sample.id, "Mad", datetime.now(), 5.5, "pending"
            )
            db.session.commit()
...
class TestImportCHPPWide:
    ...
    def test_import_chpp_wide_valid(self, app):
        ...
        from app.routes.import_routes import _import_chpp_wide
        import csv
...
class TestImportLongFormat:
    ...
    def test_import_long_format_valid(self, app):
        ...
        from app.routes.import_routes import _norm, _parse_date, _base_code
